...
######### JUST RUN CODE BELOW - NOT (YET) CASE SPECIFIC #######################
...
# we have monthly data, so lambda1 and lambda2 are multiplied by three to induce less shrinkage

...
netlong_mm <- data$netlong_mm[-1]/1000 # Dividing by 1000 to make numbers comparable to BVAR
netlong_swap<-data$netlong_swap[-1]/1000 # "" 
reer_log<-reer_log[-1]
...
irf1 <- irf(var_mm_w, impulse = "ind_prod_log_diff", response = "p_wheat_log_diff", n.ahead = 12, boot = TRUE, nboot = nboot, ci = 0.95, boot.type = "rdwb")
irf2 <- irf(var_mm_w, impulse = "exports_total_log_diff", response = "p_wheat_log_diff", n.ahead = 12, boot = TRUE, nboot = nboot, ci = 0.95, boot.type = "rdwb")
irf3 <- irf(var_mm_w, impulse = "netlong_mm", response = "p_wheat_log_diff", n.ahead = 12, boot = TRUE, nboot = nboot, ci = 0.95, boot.type = "rdwb")
...
irf4 <- irf(var_sd_w, impulse = "ind_prod_log_diff", response = "p_wheat_log_diff", n.ahead = 12, boot = TRUE, nboot = nboot, ci = 0.95, boot.type = "rdwb")
irf5 <- irf(var_sd_w, impulse = "exports_total_log_diff", response = "p_wheat_log_diff", n.ahead = 12, boot = TRUE, nboot = nboot, ci = 0.95, boot.type = "rdwb")
irf6 <- irf(var_sd_w, impulse = "netlong_swap", response = "p_wheat_log_diff", n.ahead = 12, boot = TRUE, nboot = nboot, ci = 0.95, boot.type = "rdwb")
